...
function testPageWidthModifiersExist() {
  ...
  assert.match(css, /:where\(\.report-entry-page\) \.report-submit-confirm-modal-card \{[\s\S]*--report-submit-modal-title-size: clamp\(28px, 5\.6vw, 32px\);[\s\S]*--report-submit-modal-subtitle-size: clamp\(20px, 4\.4vw, 24px\);[\s\S]*--report-submit-modal-label-size: clamp\(22px, 4\.8vw, 26px\);[\s\S]*--report-submit-modal-value-size: clamp\(24px, 5\.2vw, 28px\);[\s\S]*--report-submit-modal-button-size: clamp\(24px, 5vw, 28px\);[\s\S]*border: var\(--line-strong\) solid var\(--modal-shell-border\) !important;[\s\S]*border-radius: var\(--radius-lg\);/);
  assert.match(css, /:where\(\.report-entry-page\) \.report-submit-confirm-modal-card \.confirm-summary-modal-title \{[\s\S]*font-size: var\(--report-submit-modal-title-size\);[\s\S]*line-height: 1\.08;/);
  assert.match(css, /:where\(\.report-entry-page\) \.report-submit-confirm-modal-card \.confirm-summary-modal-subtitle \{[\s\S]*font-size: var\(--report-submit-modal-subtitle-size\);[\s\S]*line-height: 1\.18;/);
  assert.match(css, /:where\(\.report-entry-page\) \.report-submit-confirm-modal-list \.k \{[\s\S]*font-size: var\(--report-submit-modal-label-size\);[\s\S]*font-weight: 800;/);
  ...
  assert.match(css, /:where\(\.report-entry-page\) \.report-submit-confirm-modal-actions \.btn \{[\s\S]*min-height: 58px;[\s\S]*font-size: var\(--report-submit-modal-button-size\);/);
